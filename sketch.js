...
class Obstacle {
  ...
  hits(dino, gameY) {
    if (this.isPlatform) {
      ...
      if (dino.vy >= 0 && 
          dinoBottom >= platformTop - 10 && 
          dinoBottom <= platformTop + 15 &&
...
class DinoGame {
  ...
  update(gameY) {
    ...
    if (frameCount % 180 === 0) {
      this.gameSpeed = min(this.gameSpeed + 0.5, 12);
    }
  }
...
function generateQuestions() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        if (operation === 0) {
            num1 = floor(random(1, 50));
            num2 = floor(random(1, 50));
            answer = num1 + num2;
            text = num1 + " + " + num2;
        } else if (operation === 1) {
            ...
            num1 = floor(random(2, 11));
            num2 = floor(random(2, 11));
            answer = num1 * num2;
            text = num1 + " × " + num2;
        } else {
            num2 = floor(random(2, 11));
            answer = floor(random(2, 11));
            num1 = num2 * answer;
            text = num1 + " ÷ " + num2;
        }
